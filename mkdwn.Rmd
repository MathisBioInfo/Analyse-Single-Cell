---
title: "Analyse single cell des MSC starvé et non starvé"
author: "DUPUY Mathis"
date: "10/7/2022"
output:
...
Nous pouvons observer que chaque échantillons est composé d'un peu moins de 1500
cellules.
...
deux groupes est de l'ordre des $10^{4}$.
...
Nous réalisons que la majeure partie des cellules de qualitées se trouvent dans le
cadran supérieur droit formé par nos filtres. Ceux-ci semblent donc adaptés à
